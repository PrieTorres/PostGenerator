...
export const PostCard = ({ post }) => {
  ...
  return (
    <div className={style.post} data-testid="loaded-post">
      <img
        className={`${style["post-image"]} ${imageNotLoaded? style["error-image"] : ""}`}
      ...
      />
      {imageNotLoaded? <div className={`${style["post-image"]} ${style["image-error-div"]}`} data-testid="div-error-image">;(</div> : ""}
